...
public class Message {
    ...
    public static final String MISSING_TODO_CONTENT_MESSAGE = SpaceAndLine.SEPARATION_LINE + "\n" +
            SpaceAndLine.SHORT_SPACE + "☹ OOPS!!! The description of a todo cannot be empty.\n" +
            SpaceAndLine.SEPARATION_LINE + "\n";
    public static final String MISSING_DEADLINE_CONTENT_MESSAGE = SpaceAndLine.SEPARATION_LINE + "\n" +
            SpaceAndLine.SHORT_SPACE + "☹ OOPS!!! The description of a deadline cannot be empty.\n" +
            SpaceAndLine.SEPARATION_LINE + "\n";
    public static final String MISSING_EVENT_CONTENT_MESSAGE = SpaceAndLine.SEPARATION_LINE + "\n" +
            SpaceAndLine.SHORT_SPACE + "☹ OOPS!!! The description of a event cannot be empty.\n" +
            SpaceAndLine.SEPARATION_LINE + "\n";
    public static final String MISSING_DELETE_INDEX_MESSAGE = SpaceAndLine.SEPARATION_LINE + "\n" +
            SpaceAndLine.SHORT_SPACE + "☹ OOPS!!! The index of the deletion cannot be empty.\n" +
            SpaceAndLine.SEPARATION_LINE + "\n";
    public static final String WRONG_DELETE_INDEX_MESSAGE = SpaceAndLine.SEPARATION_LINE + "\n" +
